...
public static class ReservedMetadataKeys : Object
{
    ...
    /// <summary>
    /// Key added to an edge to set the edge's tooltip when using
    /// NodeXLControl.
    /// </summary>
    /// 
    /// <remarks>
    ...
    /// <para>
    /// For tooltips to be visible, you must set
    /// NodeXLControl.UseEdgeToolTips to true. The default value is false.
    /// </para>
    /// 
    /// </remarks>
    /// 
    public static readonly String PerEdgeToolTip =
        FirstChar + "ETT";
